...
function push_analytics( key,path,category ){
    // mixpanel.track();
    if(key=="event"){ 
      ga("send", key, category,path);
    }else{
       ga("send", key, path);
    }
